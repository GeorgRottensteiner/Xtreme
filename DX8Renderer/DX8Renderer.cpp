...
static CDX8RenderClass* pDX8RendererInstance = NULL;
...
XRenderer* GetInterface()
{
  ...
  if ( pDX8RendererInstance == NULL )
  {
    static CDX8RenderClass    dx8Instance( (HINSTANCE)g_hModule );

    return &dx8Instance;
  }
  return pDX8RendererInstance; 
