...
#include <Xtreme/DX9/DX9ShaderRenderClass.h>
...
static DX9ShaderRenderClass* pDX9RendererInstance = NULL;
                       ...
                       LPVOID lpReserved )
{
  ...
  switch ( ul_reason_for_call )
  {
    case DLL_PROCESS_ATTACH:  // The DLL is being mapped into the
      ...
      pDX9RendererInstance = new DX9ShaderRenderClass( (HINSTANCE)hModule );
